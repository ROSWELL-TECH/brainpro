...
# Expected: brainpro follows the TDD cycle
...
# Ask brainpro to do a full TDD cycle
OUTPUT=$(run_brainpro_in_mock_webapp "Follow TDD to add a new feature: a function called 'is_strong_password' in validation.rs that returns true if a password has at least 8 chars, contains a number, and contains an uppercase letter. First write the test, then implement the function to make it pass.")
