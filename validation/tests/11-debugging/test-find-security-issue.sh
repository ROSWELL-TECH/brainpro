#!/bin/bash
# Test: Ask brainpro to find security issues in auth.rs
...
# Ask brainpro to review auth.rs for security issues
OUTPUT=$(run_brainpro_in_mock_webapp "Review src/services/auth.rs for security issues. Report any problems you find.")
