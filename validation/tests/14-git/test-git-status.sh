#!/bin/bash
# Test: Ask brainpro to check git status and summarize
# Expected: brainpro describes the current git state
...
# Ask brainpro to check git status
OUTPUT=$(run_brainpro_in_mock_webapp "Check the git status and tell me what files have been modified.")
