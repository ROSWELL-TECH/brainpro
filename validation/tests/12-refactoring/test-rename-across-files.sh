#!/bin/bash
# Test: Ask brainpro to rename a struct across files
# Expected: brainpro renames User to AppUser in all files
...
# Ask brainpro to rename User to AppUser
OUTPUT=$(run_brainpro_in_mock_webapp "Rename the User struct to AppUser across the entire codebase. Update all imports, usages, and references. Make sure the code still compiles.")
