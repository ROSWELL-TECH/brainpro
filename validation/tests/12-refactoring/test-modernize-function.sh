#!/bin/bash
# Test: Ask brainpro to remove a deprecated function
# Expected: brainpro removes old_query and updates any callers
...
# Ask brainpro to remove the deprecated function
OUTPUT=$(run_brainpro_in_mock_webapp "The function old_query in src/services/database.rs is deprecated. Remove it from the codebase. Make sure the code still compiles after removal.")
