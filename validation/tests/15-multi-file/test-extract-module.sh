#!/bin/bash
# Test: Ask brainpro to extract code into a new module
# Expected: brainpro creates a new module and updates imports
...
# Ask brainpro to create a new errors module
OUTPUT=$(run_brainpro_in_mock_webapp "Create a new module src/errors.rs that defines an AppError enum with variants NotFound, InvalidInput, and Unauthorized. Add it to lib.rs. Make sure the code compiles.")
